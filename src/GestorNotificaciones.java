...
public class GestorNotificaciones implements IGestorNotificaciones {
	...
	public static void añadirSuscriptor(Cliente suscriptor, List<Cliente> listaSuscriptores) {
		listaSuscriptores.add(suscriptor);
	}

	public static void eliminarSuscriptor(Cliente suscriptor, List<Cliente> listaSuscriptores) {
